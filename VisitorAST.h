...
public:
    FunctionList_Node(Type_Node *type, Token_Node *id, VarList_Node *varlist, StmtList_Node *stmtlist, FunctionList_Node *next);
    FunctionList_Node(){};
    ~FunctionList_Node();
...
public:
    NameDecl_Node(Type_Node *type, Token_Node *id);
    ~NameDecl_Node();
